...
with open("data_arduino/arduino_data_{sys.argv[1]}.txt", "r") as fda:
    arduino_data = fda.read()

with open("data_stage/stage_data_{sys.argv[1]}.txt", "r") as fds:
    stage_data = fds.read()
...
position = [sublist[2] for sublist in stage_data]
