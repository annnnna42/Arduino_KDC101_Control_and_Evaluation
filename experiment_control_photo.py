...
def get_position_stage(direction):
    ...
    if direction == "fw":
        position_data.append([position, None, None, None])
    elif direction == "bw":
        position_data.append([None, position, None, None])
    elif direction == "at end":
        position_data.append([None, None, position, None])
    elif direction == "at start":
        position_data.append([None, None, None, position])
...
with Thorlabs.KinesisMotor("27267730") as stage:
    ...
    ser = ser_config() 
    scale_pos, start_mm, end_mm, acc, maxv = stage_config()
